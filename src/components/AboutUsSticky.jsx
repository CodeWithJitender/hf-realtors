                        ...
                        {tabs.map((tab, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={`font-sans transition-colors duration-300 whitespace-nowrap ${isActive ? 'text-[#FFED7E] font-bold text-base md:text-lg lg:text-xl' : 'text-[#8A98A5] font-semibold text-base md:text-lg lg:text-xl group-hover:text-[#EDEDED]'}`}>
                                        {tab.label}
                                    </span>
                                </div>
                            );
