    ...
    return (
        <section ref={containerRef} className="relative w-full h-[300vh] bg-[#7A1315] z-20">
            ...
            <div className="sticky top-0 w-full h-screen overflow-hidden bg-[#7A1315] z-10 flex flex-col justify-center items-center">
                ...
                <motion.div style={{ opacity: uiOpacity }} className="absolute top-1/2 left-8 -translate-y-1/2 flex items-center gap-4 z-0 text-[#EDEDED] 'Helvetica Neue', Helvetica, Arial, sans-serif text-xs tracking-widest font-bold">
                    [+] NAVIGATION
                </motion.div>
                <motion.div style={{ opacity: uiOpacity }} className="absolute top-1/2 left-40 -translate-y-1/2 flex items-center gap-4 z-0 text-[#EDEDED] 'Helvetica Neue', Helvetica, Arial, sans-serif text-xs tracking-widest font-bold">
                    RU
                </motion.div>
                <motion.div style={{ opacity: uiOpacity }} className="absolute top-1/2 right-8 -translate-y-1/2 flex items-center gap-4 z-0 text-[#EDEDED] 'Helvetica Neue', Helvetica, Arial, sans-serif text-xs tracking-widest font-bold">
                    LET'S DISCUSS ↗
                </motion.div>
