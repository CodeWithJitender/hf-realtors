...
export default function KeyholeGateway() {
    ...
    return (
        <section ref={containerRef} className="relative w-full h-[300vh] bg-[#0A1628]">
            <div className="sticky top-0 w-full h-screen overflow-hidden">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute inset-0 bg-[#0A1628] z-10 will-change-transform pointer-events-auto"
                    >
