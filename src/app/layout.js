  ...
  return (
    <html lang="en">
      <body className="antialiased" style={{ backgroundColor: "#0A1628", color: "#FFFFFF", fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
        ...
        <Script id="livechat-script" strategy="afterInteractive" dangerouslySetInnerHTML={{
          __html: `
        ...
        <noscript>
          <a href="https://www.livechat.com/chat-with/19645795/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a>
        </noscript>
      </body>
    </html>
  );
