...
export default function SiteFooter() {
  return (
    <footer className="relative w-full bg-[#161F48] overflow-hidden pt-20 pb-16">
       
       {/* Background Skyline Image */}
       <div 
         className="absolute inset-0 w-full h-[80%] pointer-events-none mix-blend-screen z-0"
         style={{
       ...
       <div className="absolute bottom-0 inset-x-0 w-full flex justify-center overflow-hidden pointer-events-none z-0">
          <span 
            className="text-[18vw] font-bold leading-[0.8] tracking-[0.1em] lowercase whitespace-nowrap select-none bg-gradient-to-b from-[#E8C96A] to-[#B8913A] text-transparent bg-clip-text opacity-[0.05]"
       ...
       {/* TOP SECTION: Heading and Floating Gold Circle */}
       <div className="w-full relative flex items-center justify-center pt-8 pb-12 z-20 overflow-visible">
         {/* The Text */}
         <div className="relative z-20 max-w-6xl w-full px-6 flex justify-center">
            <h2 
              className="text-[#7C8BD2] text-3xl md:text-[40px] font-light tracking-wide text-center leading-tight relative w-fit"
              style={{ fontFamily: "'Poppins', sans-serif" }}
            >
               Your journey to the right property begins with us
               {/* Floating Gold Element EXACTLY intersecting text without massive blur */}
               <div className="absolute -right-8 md:-right-20 top-1/2 -translate-y-[45%] w-24 h-24 md:w-32 md:h-32 rounded-full bg-[#DCA43B] opacity-90 -z-10"></div>
            </h2>
         </div>
       </div>

       {/* FULL WIDTH HORIZONTAL LINE */}
       <div className="w-full h-[1px] bg-[#D9D9D9]/20 relative z-20"></div>

       {/* BOTTOM SECTION: 4 Columns Grid */}
       <div className="relative z-20 max-w-[1400px] mx-auto px-6 lg:px-16 pt-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 w-full">
            ...
            <div className="flex flex-col gap-2.5 text-[#D9D9D9] text-[15px] font-light items-center sm:items-start pt-1">
            ...
            <div className="flex gap-4 items-start justify-center sm:justify-start pt-1">
               ...
               <a aria-label="YouTube" href="#" className="flex items-center justify-center text-[#E8C96A] hover:opacity-75 transition-opacity">
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="currentColor"><path d="M21.582 6.186a2.632 2.632 0 0 0-1.85-1.879C18.093 3.882 12 3.882 12 3.882s-6.093 0-7.732.425a2.632 2.632 0 0 0-1.85 1.879C2 7.854 2 12 2 12s0 4.146.418 5.814a2.632 2.632 0 0 0 1.85 1.879C5.907 20.118 12 20.118 12 20.118s6.093 0 7.732-.425a2.632 2.632 0 0 0 1.85-1.879C22 16.146 22 12 22 12s0-4.146-.418-5.814zM10.007 15.116V8.884L15.345 12l-5.338 3.116z"/></svg>
               </a>
            </div>

            {/* Col 4: Contact Pills */}
            <div className="flex flex-col gap-4 items-center sm:items-start lg:items-end w-full pt-1">
               {/* Mail Pill */}
               <a href="mailto:info@hfrealtors.com" className="w-[90%] sm:w-min px-6 py-3 rounded-[2rem] border border-[#E8C96A]/60 bg-transparent text-[#D9D9D9] hover:bg-[#E8C96A] hover:text-[#161F48] transition-colors text-[14px] font-light tracking-wide flex items-center justify-center sm:justify-start gap-4">
                 ...
                 <span className="whitespace-nowrap">info@hfrealtors.com</span>
               </a>

               {/* Phone Pill */}
               <a href="tel:9999991036" className="w-[90%] sm:w-min px-6 py-3 rounded-[2rem] border border-[#E8C96A]/60 bg-transparent text-[#D9D9D9] hover:bg-[#E8C96A] hover:text-[#161F48] transition-colors text-[14px] font-light tracking-wide flex items-center justify-center sm:justify-start gap-4">
